  ...
  const features = [
    {
      ...
      title: "Unmetered Resources",
      description: "You get unmetered (fair-usage) RAM and CPU specifications, ensuring a lag-free experience unlike the rest!"
    },
    {
      icon: <WrenchScrewdriverIcon className="w-50 text-green-500" />,
      title: "Amazing Features",
      description: "Our easy-to-use features allows easy installations of many different plugins, mods, and much, much more."
    },
    {
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mt-16 grid grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-3">
          {features.map((feature, index) => (
            <div 
              key={index}
              className="relative overflow-hidden z-10 hover:-translate-y-2 transform transition-all duration-300 bg-[#0e1024] text-black rounded-xl shadow-md"
            >
              <div className="p-4">
