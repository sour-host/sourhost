            ...
            <div className="prose prose-blue max-w-none">
              ...
              <section className="pt-22" id="contact">
                ...
                <p>
                  ...
                  <Link href="mailto:legal@voxelservers.com" className="text-[#00b72f] hover:underline">
                    legal@voxelservers.com
                  </Link>.
                </p>
              </section>
            </div>
