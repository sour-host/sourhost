          ...
          <div className="flex justify-between items-center">
            ...
            <nav className="hidden lg:flex items-center space-x-6">
              ...
              <div className="relative group">
                ...
                <div className="absolute left-0 top-full mt-1 w-64 bg-[rgba(16,11,34,0.9)] backdrop-blur-lg rounded-3xl opacity-0 invisible translate-y-2 group-hover:opacity-100 group-hover:visible group-hover:translate-y-0 transition-all duration-200 pointer-events-none group-hover:pointer-events-auto">
                  {/* Dropdown content */}
                  <div className="p-4">
